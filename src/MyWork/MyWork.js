...
class MyWork extends Component {
    ...
    handleScroll = (e) => {
        ...
        if (scrollPosition > 753){
            ...
            if (workTitle.className === "workTitle") {
                workTitle.className += "Animation";
                workDesc.className += "Animation";
            }
        }
        
        if (scrollPosition > 942){
            var projectImages = document.getElementById("projectImages")
            if (projectImages.className === "projectImages") {
                projectImages.className += "Animation";
            }
        }
    }
    ...
    render(){
        ...
        return(
           <div id = "myWork">
                <p id = "workTitle" className = "workTitle">My Work</p>
                <p id = "workDesc" className = "workDesc">I have worked on few amazing projects which I picked up for you.</p>
                <div id = "projectImages" className = "projectImages">
                    <div id = "work1">
                        <div id = "image1">
